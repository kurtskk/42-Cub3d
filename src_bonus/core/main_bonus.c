...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2026/02/12 14:10:27 by jose-cad          #+#    #+#             */
/*   Updated: 2026/02/12 14:10:32 by jose-cad         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void	init_mlx(t_cub *cub)
{
	...
	cub->z_buffer = (double *)ft_calloc(WIN_WIDTH, sizeof(double));
	if (!cub->z_buffer)
		error_exit_cleanup(cub, "Error\nZ-Buffer alloc failed\n");
}
